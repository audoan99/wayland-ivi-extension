...
{
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&mp_iviScreen[0], 1);
...
{
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&mp_iviScreen[0], 1);
    struct ivi_layout_layer *l_layoutLayer[1];
    SET_RETURN_SEQ(get_layer_from_id, &l_layoutLayer[0], 1);
...
{
    struct wl_resource * screenshot[1];
    SET_RETURN_SEQ(wl_resource_create, &screenshot[0], 1);
...
{
    SET_RETURN_SEQ(commit_changes, &mp_failureResult[0], 1);
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&mp_iviController[0], 1);
...
{
    SET_RETURN_SEQ(commit_changes, &mp_successResult[0], 1);
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&mp_iviController[0], 1);
...
{
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&mp_iviController[0], 1);
    struct ivi_layout_surface *l_layout_surface[1];
    SET_RETURN_SEQ(get_surface_from_id, &l_layout_surface[0], 1);
...
{
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&mp_iviController[0], 1);
    struct ivi_layout_layer *l_layout_layer[1];
    SET_RETURN_SEQ(get_layer_from_id, &l_layout_layer[0], 1);
...
{
    const struct ivi_layout_surface_properties *prop[1];
    ...
    prop[0] = &l_prop;
    SET_RETURN_SEQ(get_properties_of_surface, &prop[0], 1);
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&mp_iviController[0], 1);
    struct ivi_layout_surface *l_layout_surface[1];
    SET_RETURN_SEQ(get_surface_from_id, &l_layout_surface[0], 1);
...
{
    const struct ivi_layout_layer_properties *prop[1];
    ...
    prop[0] = &l_prop;
    SET_RETURN_SEQ(get_properties_of_layer, &prop[0], 1);
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&mp_iviController[0], 1);
    struct ivi_layout_layer *l_layout_layer[1];
    SET_RETURN_SEQ(get_layer_from_id, &l_layout_layer[0], 1);
...
TEST_F(ControllerTests, controller_surface_sync_add)
{
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&mp_iviController[0], 1);
    struct ivi_layout_surface *l_layout_surface[1];
    l_layout_surface[0] = &m_layoutSurface[0];
    SET_RETURN_SEQ(get_surface_from_id, &l_layout_surface[0], 1);
...
TEST_F(ControllerTests, controller_layer_sync_add)
{
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&mp_iviController[0], 1);
    struct ivi_layout_layer *l_layout_layer[1];
    l_layout_layer[0] = &m_layoutLayer[0];
    SET_RETURN_SEQ(get_layer_from_id, &l_layout_layer[0], 1);
...
TEST_F(ControllerTests, controller_surface_get_success)
{
    ...
    l_layout_surface[0] = &m_layoutSurface[0];
    SET_RETURN_SEQ(get_surface_from_id, &l_layout_surface[0], 1);
    struct weston_surface *l_surface[1];
    SET_RETURN_SEQ(surface_get_weston_surface, &l_surface[0], 1);
...
TEST_F(ControllerTests, controller_layer_get_success)
{
    ...
    l_layout_layer[0] = &m_layoutLayer[0];
    SET_RETURN_SEQ(get_layer_from_id, &l_layout_layer[0], 1);
    const struct ivi_layout_layer_properties *l_prop[1];
    l_prop[0] = &m_layoutLayerProperties[0];
    SET_RETURN_SEQ(get_properties_of_layer, &l_prop[0], 1);
...
TEST_F(ControllerTests, controller_surface_screenshot_success)
{
    ...
    surface_get_size_fake.custom_fake = custom_surface_get_size;
    SET_RETURN_SEQ(surface_dump, &mp_successResult[0], 1);
...
TEST_F(ControllerTests, controller_create_layout_layer_success)
{
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&mp_iviController[0], 1);
    struct ivi_layout_layer *l_layoutLayer[1];
    SET_RETURN_SEQ(layer_create_with_dimension, &l_layoutLayer[0], 1);
...
{
    struct screenshot_frame_listener *l_listener[1];
    l_listener[0] = (struct screenshot_frame_listener*)malloc(sizeof(struct screenshot_frame_listener));
    SET_RETURN_SEQ(wl_resource_get_user_data, (void**)&l_listener[0], 1);
...
{
    layer_event_remove(&mp_iviShell->layer_removed, &m_layoutLayer[0]);
...
{
    surface_event_remove(&mp_iviShell->surface_removed, &m_layoutSurface[0]);
...
TEST_F(ControllerTests, surface_event_configure_nullBkgndView)
{
    ...
    SET_RETURN_SEQ(weston_view_create, &l_bkgnd_view[0], 1);
